...
void include_events(FILE *f) {
  ...
  if(posicaoDesactive == -1){
    ...
    if (posicao == -1) {
      ...
      if(strcmp(e.diaSemana, "Sabado") == 0 || strcmp(e.diaSemana, "Sábado")== 0 || strcmp(e.diaSemana, "sabado")== 0  || strcmp(e.diaSemana, "sábado")== 0 || strcmp(e.diaSemana, "Sab") == 0 || strcmp(e.diaSemana, "Sáb") == 0|| strcmp(e.diaSemana, "sab") == 0|| strcmp(e.diaSemana, "sáb")== 0){
