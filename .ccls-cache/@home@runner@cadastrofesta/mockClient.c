...
void test_all_client_functions() {
  ...
  munit_assert_int(test_start_clients_operation(6), ==, 6);
  munit_assert_int(test_start_clients_operation(7), ==, 7);
  //test_locate_client
  ...
  //test_view_clients_id
  int client[10] = {1,3,2,5,6,7,8,9,4,10};
  munit_assert_int(test_view_clients_id(active1,client, 1), ==, 1);
  munit_assert_int(test_view_clients_id(active1,client, 7), ==, 0);
  munit_assert_int(test_view_clients_id(active3,client, 7), ==, 0);
  //test_view_clients_name
  char nome[100] = "Carlos";
  munit_assert_int(test_view_clients_name(active1,nome), ==, 1);
  strcpy(nome, "Jose");
  munit_assert_int(test_view_clients_name(active1,nome), ==, 0);
  munit_assert_int(test_view_clients_name(active3,nome), ==, 0);
