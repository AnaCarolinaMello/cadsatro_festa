...
void test_all_event_functions() {
  ...
  char hora[100] = "18:00";
  munit_assert_int(test_check_event_day_time(dia, hora), ==, 0);
  strcpy(hora, "20:00");
  munit_assert_int(test_check_event_day_time(dia, hora), ==, 1);
  strcpy(dia, "13/12/12");
  strcpy(hora, "18:00");
  munit_assert_int(test_check_event_day_time(dia, hora), ==, 1);
  ...
  // test_include_event
  munit_assert_int(test_include_event(-1, 1), ==, 0);
  munit_assert_int(test_include_event(1, -1), ==, 2);
  munit_assert_int(test_include_event(1, 1), ==, 3);
  munit_assert_int(test_include_event(-1, -1), ==, 1);
  // test_change_event
  munit_assert_int(test_change_event(-1), ==, 0);
  munit_assert_int(test_change_event(1), ==, 1);
  // test_delete_event
...
int test_check_event_day_time(char data[100], char horaInicio[100]){
...
int test_include_event(int posicaoDesactive, int posicao) {
...
int test_change_event(int posicao) {
  if (posicao != -1) {
    return 1;
  } else {
    return 0;
